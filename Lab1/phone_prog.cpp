...
void menu_yazdir(){
	...
	cout << "C: Exit" << endl;
	cout << endl;
	cout << "Enter your option {S, A, U, D, M, E} : ";
}
...
void kayit_maintenance(){
	int sayi;
	sayi = defter.maintenance();
	if (sayi == 0)
		cout << "there is no empty record." << endl;
	else
		cout << sayi << " kadar empty record temizlendi." << endl;
}